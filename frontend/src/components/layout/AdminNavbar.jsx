      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex relative group">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-9 pr-4 py-2 w-40 sm:w-72 bg-[#f0f3f5] border border-transparent rounded-lg text-sm text-[#8f9192] focus:outline-none focus:bg-[#fdfdfe] focus:border-[#3d766d] focus:ring-2 focus:ring-[#3d766d]/20 transition-all placeholder:text-[#bdc2c7]"
          />
        </div>
      </div>
