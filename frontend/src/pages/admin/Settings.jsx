    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6 animate-in fade-in">
      ...
      <div className="flex gap-4 border-b border-[#d6d9df]">
        {[
          ...
          { id: 'leave-types', label: 'Leave Management', icon: CalendarDays },
      ...
      {activeTab === 'leave-types' && (
        <div className="bg-white rounded-xl border border-[#d6d9df] shadow-sm overflow-hidden">
          <div className="p-5 border-b border-[#d6d9df] flex justify-between items-center bg-[#f8f9fa]">
            <div>
              <h2 className="text-base font-bold text-[#1E293B]">Dynamic Leave Configuration</h2>
              <p className="text-xs text-[#8f9192] mt-0.5">Manage leave types, rules, and payroll impacts</p>
            </div>
            <button
              onClick={() => {
                setEditingLeaveType(null);
