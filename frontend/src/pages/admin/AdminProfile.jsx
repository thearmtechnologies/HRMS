...
const InfoItem = ({ label, value, icon: Icon, colSpan = 1 }) => (
  <div className={`col-span-1 ${colSpan === 2 ? "sm:col-span-2" : ""}`}>
    ...
    <p className="text-sm font-semibold text-[#3d766d]">{value}</p>
  </div>
);
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 lg:space-y-8 pb-12">
      ...
      <div className="bg-[#fdfdfe] rounded-2xl border border-[#d6d9df] shadow-sm p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#3d766d]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
        
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 relative z-10">
          {/* Avatar Section */}
          <div className="relative group shrink-0">
            <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full bg-[#3d766d] text-[#fdfdfe] flex items-center justify-center text-4xl sm:text-5xl font-bold shadow-md">
              KP
            </div>
            <button className="absolute bottom-0 right-0 p-2.5 bg-[#fdfdfe] rounded-full border border-[#d6d9df] text-[#8f9192] hover:text-[#3d766d] shadow-sm transition-colors group-hover:scale-105">
              <Camera size={18} />
            </button>
          </div>
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-2">
              <h1 className="text-2xl sm:text-3xl font-bold text-[#3d766d]">
                Kaustubh Pawar
              </h1>
              <span className="inline-flex items-center justify-center px-3 py-1 rounded-full text-xs font-bold bg-[#3d766d]/10 text-[#3d766d] self-center sm:self-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="space-y-6 lg:space-y-8">
          ...
          <div className="bg-[#fdfdfe] rounded-xl border border-[#d6d9df] shadow-sm overflow-hidden">
            <div className="p-5 border-b border-[#d6d9df] flex items-center gap-2">
              <User size={20} className="text-[#3d766d]" />
              <h2 className="text-lg font-bold text-[#3d766d]">Personal Information</h2>
            </div>
          ...
          <div className="bg-[#fdfdfe] rounded-xl border border-[#d6d9df] shadow-sm overflow-hidden">
            <div className="p-5 border-b border-[#d6d9df] flex items-center gap-2">
              <Monitor size={20} className="text-[#3d766d]" />
              <h2 className="text-lg font-bold text-[#3d766d]">Account Information</h2>
            </div>
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
        ...
        <div className="space-y-6 lg:space-y-8">
          ...
          <div className="bg-[#fdfdfe] rounded-xl border border-[#d6d9df] shadow-sm overflow-hidden">
            <div className="p-5 border-b border-[#d6d9df] flex items-center gap-2">
              <Briefcase size={20} className="text-[#3d766d]" />
              <h2 className="text-lg font-bold text-[#3d766d]">Professional Information</h2>
            </div>
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
          ...
          <div className="bg-[#fdfdfe] rounded-xl border border-[#d6d9df] shadow-sm overflow-hidden">
            <div className="p-5 border-b border-[#d6d9df] flex items-center gap-2">
              <Activity size={20} className="text-[#3d766d]" />
              <h2 className="text-lg font-bold text-[#3d766d]">Activity Timeline</h2>
            </div>
            <div className="p-6">
