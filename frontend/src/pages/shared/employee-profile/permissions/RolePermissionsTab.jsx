...
export default function RolePermissionsTab({ employee }) {
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center animate-in fade-in duration-200">
      ...
      <p className="text-[#8f9192] max-w-sm mt-2">
        This section is currently under development. Data for RolePermissions will be available here in a future update.
      </p>
    </div>
  );
}
